  ...
  try {
    ...
    const { error: dbError } = await getSupabase()
      ...
      .insert({
        ...
        golongan_darah_ayah: d.golonganDarahAyah || null,
        nik_ibu: d.nikIbu,
        ttl_ibu: d.ttlIbu,
        pekerjaan_ibu: d.pekerjaanIbu || null,
        pendidikan_ibu: d.pendidikanIbu || null,
        golongan_darah_ibu: d.golonganDarahIbu || null,
        ...
        kelas: d.kelas,
        agama: d.agama,
      golongan_darah: d.golonganDarah || null,
    ...
    if (spreadsheetId) {
      try {
        ...
        await appendToSheet(spreadsheetId, "'PPDB-JOVANKA V2'!A:A", [
          now,
          d.namaAnak,
          d.nikAnak,
          d.jkAnak,
